...
*/
int memory_rw_read(struct virt_dev *vdev, uint64_t addr, uint64_t *value, uint16_t size)
{
	return 0;
}
...
*/
int memory_rw_write(struct virt_dev *vdev, uint64_t addr, uint64_t *value, uint16_t size)
{
	struct vm *vm;
