...
#include <zephyr/dt-bindings/clock/rk3568_clock.h>
...
/**
 * @breif: init clock syscon(pmucru) for rk3568 soc.
*/
...
static const struct clock_control_driver_api rk3568_pmucru_api = {
	.on = rk3568_pmucru_clk_on,
	.off = rk3568_pmucru_clk_off,
};

static struct rk3568_clk_syscon rk3568_pmucru_cfg = {
